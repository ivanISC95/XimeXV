    ...
    <section className="invitacion_principal_body">
      <section className="invitacion_texto">
        <section className="invitacion_texto_contenido">
          ...
          <div className="invitacion_texto_contenido_h2">Estoy emocionada de celebrar mis xv años en un dia lleno de alegría y recuerdos inolvidables, te invito a celebrar el inicio de una nueva etapa en mi vida, llena de sueños, metas y grandes logros</div>                    
          <div className="invitacion_texto_contenido_h3">
            Danna Ximena Ugalde Perez
          </div>
        </section>
      </section>
